...
Pour savoir si un sommet $v$ est une feuille ou non, nous utilisons un booléen $isInCover$ qui vaut $False$ au début de la visite de $v$. Quand on rencontre pour la première fois un de ses voisins non déjà visité, le sommet $v$ est ajouté dans la couverture du graphe et la valeur de $isInCover$ est mise à $True$.
...
\Sinon{
	coverV = petiteCouvertureAlg(g2,k-1,n'-1)
