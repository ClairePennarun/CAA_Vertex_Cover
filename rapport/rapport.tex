...
Finalement, la complexité de l'algorithme glouton est $O(c*n)$ (où $c$ est la taille de la couverture renvoyée).
...
Finalement, la complexité finale de l'algorithme glouton est $O(c*n)$ (où $c$ est la taille de la couverture renvoyée).
